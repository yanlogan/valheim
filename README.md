...
| Портал «прохожу насквозь» / нет телепорта (особенно с базы) | **Yanlo-PortalWardFix** из zip + **WardIsLove**. Баг WardIsLove: радиус последнего инициализированного варда ломает считывание близости портала |
